...
default_grid = (x_st = x_st, x_ed = x_ed, y_st = y_st, y_ed = y_ed, n_x = n_x, n_y = n_y, k = 20)
...
# reorder_to_natural: recursion order -> one-dimensional natural order.
# reorder_to_natural_grid: recursion order -> n_y x n_x grid, ready for contour.
